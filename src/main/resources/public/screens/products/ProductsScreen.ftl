...
[@MainLayout title="${vm.title}"]
    ...
    <ul class="products-grid">
        [#list vm.productAnchors as productAnchor]
            <li>
                <article>
                    [@Anchor href=productAnchor.anchor.href class=productAnchor.anchor.scssClass target=productAnchor.anchor.target current=productAnchor.anchor.ariaCurrent]
                        <img src=${productAnchor.imageSource}>
                        <h2>${productAnchor.anchor.text}</h2>
                    [/@Anchor]
                </article>
            </li>
        [/#list]
